...
def run_mtp_decode(
    ...
    Args:
        ...
        cache_stride: Stride for intermediate state caching.
    """
    # Select kernel variant based on batch size
    use_original_kernel = B < 8
    use_smem_kernel = False  # Disabled: SMEM kernel is slower
    ...
    if use_original_kernel:
        ...
        # Optimized register-resident state kernel with ILP rows
